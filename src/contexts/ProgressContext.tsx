...
export function ProgressProvider({ children }: { children: ReactNode }) {
  ...
  // ⚡ Bolt Optimization: Build an O(1) lookup map for progress items
  // This prevents O(N*M) renders when rendering long lists of ItemCards
  // where N is the number of rendered items and M is the progress array length.

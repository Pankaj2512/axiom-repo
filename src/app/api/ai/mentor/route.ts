...
`;
    ...
    // 🛡️ Sentinel: Securely log the error on the server and return a generic message
    console.error("AI Mentor Error:", error);
    return NextResponse.json({ error: 'An unexpected error occurred while consulting the mentor.' }, { status: 500 });
  }
}

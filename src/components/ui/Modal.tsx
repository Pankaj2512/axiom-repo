      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-gray-400 hover:text-white transition-colors p-1 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]"
          >
            <X className="w-5 h-5" />
          </button>
        </div>

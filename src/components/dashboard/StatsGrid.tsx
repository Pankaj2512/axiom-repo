...
import { tracks, TOTAL_TRACK_ITEMS } from '@/data/tracks';
...
export function StatsGrid() {
  ...
  const totalItems = TOTAL_TRACK_ITEMS;
  ...
  const { completedItems, overallPercentage, thisWeekCompleted } = React.useMemo(() => {
    ...
    return { completedItems: completedCount, overallPercentage: percentage, thisWeekCompleted: thisWeekCount };
  }, [progress, totalItems]);

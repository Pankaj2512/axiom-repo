...
// Calculate total static items once outside the component
...
export function StatsGrid() {
  ...
  // Single pass calculation for progress stats
  const { completedItems, thisWeekCompleted } = React.useMemo(() => {
    ...
    for (const p of progress) {
      if (p.status === 'COMPLETED') {
        ...
        if (p.completedAt) {
          const timestamp = p.completedAt instanceof Date

...
export function StatsGrid() {
  ...
  // Calculate stats
  // Memoize these calculations to prevent O(N) array filtering when unrelated context updates trigger a re-render.
  const { totalItems, completedItems, overallPercentage, thisWeekCompleted } = React.useMemo(() => {
    ...
    return { totalItems, completedItems, overallPercentage, thisWeekCompleted };
  }, [progress]);

...
// Pre-calculate total items outside component to prevent O(N) recalculation on every render
...
export function StatsGrid() {
  ...
  // Calculate stats with a single pass over the progress array, memoized to prevent recalculation

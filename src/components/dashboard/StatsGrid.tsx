...
// Calculate static stats outside component
...
export function StatsGrid() {
  ...
  // ⚡ Bolt Performance Optimization: Single pass memoized progress calculation
  // Combines two O(N) filter loops into one and memoizes the result to prevent recalculation on every render

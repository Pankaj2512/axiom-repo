...
// Pre-calculate static total counts outside component to run once at initialization
...
export function StatsGrid() {
  ...
  // Memoize O(N) array filtering to prevent recalculation when unrelated context updates
  ...
  const { completedItems, overallPercentage, thisWeekCompleted } = React.useMemo(() => {
    ...
    return { completedItems: completed, overallPercentage: percentage, thisWeekCompleted: thisWeek };
  }, [progress]);

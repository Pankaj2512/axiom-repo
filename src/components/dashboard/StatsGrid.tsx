...
// Pre-calculate static totalItems outside component to avoid recalculation on every render
...
export function StatsGrid() {
  ...
  // Memoize expensive array filtering to prevent O(N) recalculations on unrelated context updates

...
// Pre-calculate total items outside the component as it relies on static data
...
export function StatsGrid() {
  ...
  // Memoize completed items calculation to prevent O(N) recalculation on unrelated renders
  ...
  // Memoize this week's completed items calculation
  const thisWeekCompleted = React.useMemo(() => {

      ...
      >
        ...
        <div className="flex items-start gap-3">
          <button
            ...
            className="mt-0.5 flex-shrink-0 text-gray-400 hover:text-[var(--success)] transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]"

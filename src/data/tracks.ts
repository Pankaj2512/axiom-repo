...
// Pre-compute the total number of items across all tracks to avoid
// expensive recalculation during React component renders
export const TOTAL_TRACK_ITEMS = tracks.reduce((sum, track) =>

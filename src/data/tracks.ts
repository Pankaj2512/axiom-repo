 ...
 * Pre-calculating total track items here to avoid expensive O(N) nested reduce
 * operations on every render of dashboard components and analytics forecasts.
 */
...
// Pre-calculate the total items across all tracks
export const totalTrackItems = tracks.reduce((sum, track) =>
